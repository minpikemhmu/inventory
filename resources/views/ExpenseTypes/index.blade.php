  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        @endif
        <div class="tile">
          <h3 class="tile-title d-inline-block">Expense Types List</h3>
          <a href="{{route('expense_types.create')}}" class="btn btn-primary float-right">Add New</a>
            ...
            <table class="table dataTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$row->name}}</td>
                  <td>
                    <a href="{{route('expense_types.edit',$row->id)}}" class="btn btn-warning">Edit</a>
